...
?>
	...
	$sq2="select * from admin where email='$user'";
                ...
                <form method="post">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <p>
                                <div class="alert alert-danger">Are you Sure you want Delete <strong><?php echo $grade; ?>?</strong></p>
                            </div>
        ...
        <?php
                        ...
                        if(isset($_POST['delete'])){
                            ...
                            $sql1 = "DELETE FROM files WHERE id='$delete_id' ";
