										...
										<div class="col-lg-3 col-xs-6">
										  ...
										  <div class="small-box bg-aqua">
										   ...
										   ?>
											...
											<a href="http://localhost/smart_payroll/admin/employee/all_employee.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
										  </div>
										</div><!-- ./col -->
										<div class="col-lg-3 col-xs-6">
										  <!-- small box -->
										  <div class="small-box bg-green">
										   ...
										   ?>
											...
											<a href="http://localhost/smart_payroll/admin/department/department.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
										  </div>
										</div><!-- ./col -->
										<div class="col-lg-3 col-xs-6">
										  <!-- small box -->
										  <div class="small-box bg-yellow">
										   ...
										   ?>
											...
											<a href="http://localhost/smart_payroll/admin/employee/view_all.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
										  </div>
										</div><!-- ./col -->
										<div class="col-lg-3 col-xs-6">
										  <!-- small box -->
										  <div class="small-box bg-red">
										   ...
										   ?>
											...
											<a href="http://localhost/smart_payroll/admin/event.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
										  </div>
										</div><!-- ./col -->
									  </div><!-- /.row -->
									  <!-- Main row -->
