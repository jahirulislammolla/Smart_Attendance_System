...
<div class="panel panel-body">
						<div class='row'>
						<h3 style="text-align:center; color:pink;"><?php echo "Attendance "; echo $da; ?></h3>
...
?>
								<?php $result=mysqli_query($conn,"select id, nam, (select sum(date='$da') from records where id_teacher=teacher.id) count from teacher");
								$serialnumber=0;
								$counter=0;
